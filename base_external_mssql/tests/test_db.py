...
class TestMssqlInsert(TransactionCase):
    ...
    def test_insert_data(self):
        ...
        query = """INSERT INTO PPG_Artikel (Artikelid, Artikelbezeichnung,
                STATUS, Info1, Info2, Info3,
                Info4, ChVerw, SnVerw, Suchbegriff, Artikelgruppe, Einheit,
                Row_Create_Time, Row_Update_Time, isFIFO)
                VALUES (100501, 'KProdukt 801', 2, '', '', '', '', '',
                '', '', '', '', 'Sep 19 2024  2:48PM', 'Sep 19 2024  2:48PM', '')"""
